    ...
    public static void main(String[]args){
		...
		while(ciclo==1){
			...
			System.out.println("Menu");
                        ...
                        System.out.println("1.1-Agregar un Pais \t 2.1-Agregar Ciudad \t 3.1-Agregar una vinculacion\t 4.1-Listado del Paises/Ciudades \t\t ");
			System.out.println("1.2- Eliminar una Pais \t 2.1-Eliminar una ciudad 3.2-Eliminar una vinculacion \t 4.2-Listado de las Ciudades/Pais");
			...
			switch(opcion){
					...
					System.out.println("¿Que desea modificar?");
                                                ...
                                                if(desicion==1){
                                                    while(error1==1){
                                                        ...
                                                        System.out.print("Ingrese la posicion que desea modificar entre 1-100: ");
                                                        posicion = leer.nextInt();
                                                        leer.reset();

                                                        if(posicion<=100 && posicion>0){
                                                                miContenedorPais.ModificarPais(posicion);
                                                                System.out.print("Ingrese el Identificador nuevo: ");   
                                                                posicion = leer.nextInt();
                                                                leer.reset();
                                                ...
                                                if(desicion==3){
                                                    while(error1==1){
                                                        ...
                                                        if(posicion<=100 && posicion>0){
                                                                miContenedorPais.ModificarPais(posicion);
                                                                System.out.print("Ingrese el Continente nuevo: ");   
                                                                nombre = leer.next();
                                                                leer.reset();
                                                                System.out.println("Modificacion realizada exitosamente!");
                                                                error1=0;
				...
				case "3.3":
					...
					System.out.println("-----------------------------");
					System.out.println("¿Que desea modificar?");
                                        System.out.println("1-Identificador de Pais ");
                                        System.out.println("2-Identificador de Ciudad");
                                        desicion = leer.nextInt();
                                        leer.reset();
					if(desicion==1){
                                                    while(error1==1){
                                                        ...
                                                        if(posicion<=100 && posicion>0){
                                                                miContenedorPais.ModificarPais(posicion);
                                                                System.out.print("Ingrese el Identificador de Pais nuevo: ");   
                                                                posicion = leer.nextInt();
                                                                leer.reset();
                                                                System.out.println("Modificacion realizada exitosamente!");
                                                                error1=0;
                                        ...
                                        if(desicion==2){
                                                    while(error1==1){
                                                        ...
                                                        if(posicion<=100 && posicion>0){
                                                                miContenedorPais.ModificarPais(posicion);
                                                                System.out.print("Ingrese el Identificador de Ciudad nuevo: ");   
                                                                posicion = leer.nextInt();
                                                                leer.reset();
                                                                System.out.println("Modificacion realizada exitosamente!");
                                                                error1=0;
